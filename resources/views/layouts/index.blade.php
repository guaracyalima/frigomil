			...
			<div class="page-sidebar navbar-collapse collapse">
				...
				<ul class="page-sidebar-menu page-sidebar-menu-hover-submenu1" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
						...
						<ul class="sub-menu">
							<li>
								<a href="{{ route('admin.topo.index') }}">
									<span class="badge badge-roundless badge-danger"></span>Topo do site</a>
							</li>
						</ul>
					</li>
					<li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a href="{{ route('admin.sobre.index') }}">
								<span class="badge badge-roundless badge-danger"></span>Sobre</a>
							</li>
						</ul>
					</li>
					<li>
