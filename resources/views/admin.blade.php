...
<html lang="en">
  ...
  <body>
            ...
            <ul data-ason-type="menu" class="ason-widget">
              ...
              <li class="active"><a href="#"><i class="icon fa fa-file-text-o"></i><span class="title">Pages</span><span class="arrow"><i class="fa fa-angle-left"></i></span><span class="info">11</span></a>
                <ul>
                  ...
                  <li class="active"><a href="index.blade.php"><span class="title">Blank</span></a>
                  </li>
    ...
    <script src="js/plugins/page/jquery.blank.min.js"></script>
    <script src="js/plugins/tooltip/jquery.tooltipster.min.js"></script>
    <script src="js/calls/page.blank.js"></script>
